...
df = pd.read_csv('D:\\GitHub\\sentiment-analyzer\\app\\dictionaries\\original\\dict_chi_minus.csv', encoding='utf-8')
...
with open('D:\\GitHub\\sentiment-analyzer\\app\\dictionaries\\weight\\chi_minus.csv', 'w', encoding='utf-8',
          newline='') as f:
    wr = csv.writer(f)
