...
df = pd.read_csv('D:\\GitHub\\sentiment-analyzer\\app\\dictionaries\\dict_chi_plus.csv', encoding='utf-8')
...
with open('D:\\GitHub\\sentiment-analyzer\\app\\dictionaries\\weight_chi_plus.csv', 'w', encoding='utf-8',
          newline='') as f:
    wr = csv.writer(f)
